...
Version  : 7.0
Release  : 7
URL      : https://github.com/intel/x86-simd-sort/archive/v7.0/x86-simd-sort-7.0.tar.gz
Source0  : https://github.com/intel/x86-simd-sort/archive/v7.0/x86-simd-sort-7.0.tar.gz
...
%prep
%setup -q -n x86-simd-sort-7.0
cd %{_builddir}/x86-simd-sort-7.0
pushd ..
cp -a x86-simd-sort-7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747675333
