...
Version  : 5.0
Release  : 5
URL      : https://github.com/intel/x86-simd-sort/archive/v5.0/x86-simd-sort-5.0.tar.gz
Source0  : https://github.com/intel/x86-simd-sort/archive/v5.0/x86-simd-sort-5.0.tar.gz
...
%prep
%setup -q -n x86-simd-sort-5.0
cd %{_builddir}/x86-simd-sort-5.0
pushd ..
cp -a x86-simd-sort-5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707770984
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libx86simdsortcpp.so.0
