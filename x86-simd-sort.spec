...
Version  : 6.0
Release  : 6
URL      : https://github.com/intel/x86-simd-sort/archive/v6.0/x86-simd-sort-6.0.tar.gz
Source0  : https://github.com/intel/x86-simd-sort/archive/v6.0/x86-simd-sort-6.0.tar.gz
...
%prep
%setup -q -n x86-simd-sort-6.0
cd %{_builddir}/x86-simd-sort-6.0
pushd ..
cp -a x86-simd-sort-6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730754663
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libx86simdsortcpp.so.1
/usr/lib64/libx86simdsortcpp.so.1
